...
class GuardsBinanceConfigs {
  ...
  static chainConfigs: EvmConfigs = {
    ...
    addresses: {
      lock: this.binanceContractConfig.addresses.lock,
      cold: this.binanceContractConfig.addresses.cold,
      permit: this.binanceContractConfig.addresses.WatcherPermit,
      fraud: this.binanceContractConfig.addresses.Fraud,
    },
    rwtId: this.binanceContractConfig.tokens.RWTId,
