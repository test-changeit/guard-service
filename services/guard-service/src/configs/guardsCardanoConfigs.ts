...
class GuardsCardanoConfigs {
  ...
  static chainConfigs: CardanoConfigs = {
    ...
    addresses: {
      lock: this.cardanoContractConfig.addresses.lock,
      cold: this.cardanoContractConfig.addresses.cold,
      permit: this.cardanoContractConfig.addresses.WatcherPermit,
      fraud: this.cardanoContractConfig.addresses.Fraud,
    },
    rwtId: this.cardanoContractConfig.tokens.RWTId,
