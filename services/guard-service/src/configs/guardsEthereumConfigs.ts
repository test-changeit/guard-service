...
class GuardsEthereumConfigs {
  ...
  static chainConfigs: EvmConfigs = {
    ...
    addresses: {
      lock: this.ethereumContractConfig.addresses.lock,
      cold: this.ethereumContractConfig.addresses.cold,
      permit: this.ethereumContractConfig.addresses.WatcherPermit,
      fraud: this.ethereumContractConfig.addresses.Fraud,
    },
    rwtId: this.ethereumContractConfig.tokens.RWTId,
