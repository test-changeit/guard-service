...
class BitcoinRunesTransaction extends PaymentTransaction {
  ...
  constructor(
    ...
    super(BITCOIN_RUNES_CHAIN, txId, eventId, txBytes, txType);
   ...
   */
  static fromJson = (jsonString: string): BitcoinRunesTransaction => {
...
export default BitcoinRunesTransaction;
